...
- _2 hours_ More hours that feel as if they have gone down the drain trying to debug the issue of the plotly graphs not displaying and crashing.

- _2 hours_ Began work on writing the documents to be used for the user study I am looking to conduct. So far I have written the invitation request and created a general outline of the tasks I would want the users to complete. The user study will consist of an initial questionnaire, followed by simple tasks to explore the GUI, then finish with another questionnaire regarding their experience with the interface and potential areas of improvement.

### 18 Jan 2024

- _2.5 hours_ After identifying that it may in fact be a Windows installation issue as apposed to error in the code I had written, I have set up a virtual environment for the project and... the graphs display! I still have to get the functions working correctly and format it well, but to see a graph after all of these hours is a massive relief!
